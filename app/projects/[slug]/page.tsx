      ...
      <Suspense fallback={<ProjectPageLoading />}>
        <Animate className="flex flex-col gap-8 sm:gap-12">
          ...
          <ImageZoom
            ...
            className="w-full rounded-none md:rounded-[3px] bg-yellow-1050/10 dark:bg-yellow-50/10 border border-neutral-200/[0.005] dark:border-yellow-50/[0.005]"
              ...
              {project.categories && (
                <ul className="flex flex-wrap gap-2">
                  {project.categories.map((category: string, index: number) => (
                    <li
                      className="flex items-center justify-center px-3 py-1 rounded-[3px] bg-neutral-100 border border-yellow-1050/605 dark:bg-neutral-100/10 dark:border-neutral-100/5"
                      key={index}
                    >
                      {category}
                    </li>
