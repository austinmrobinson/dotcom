...
export const mdxComponents: MDXComponents = {
  ...
  img: ({ children, ...props }: any) => (
    <ImageZoom
      ...
      className="w-full object-cover aspect-[16/9] rounded-[3px] bg-yellow-1050/10 dark:bg-yellow-50/10 border border-neutral-200/[0.005] dark:border-yellow-50/[0.005]"
      {...props}
    />
  ),
