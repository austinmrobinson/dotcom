  ...
  return (
    <div className="flex gap-6">
      <div className="relative flex flex-col items-center">
        <div className="sticky z-0 mb-9 top-20 flex items-center justify-center h-8 p-4 rounded-[3px] bg-neutral-100 border border-yellow-1050/20 dark:bg-yellow-1050 dark:border-yellow-50/20">
        ...
        <span className="absolute -z-10 inset-y-0 w-[1px] bg-yellow-1050/20 dark:bg-yellow-50/20" />
      </div>
