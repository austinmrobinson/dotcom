    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        <input
          ...
          onChange={onChange}
          className={`w-full h-10 px-4 py-2.5 border-2 bg-neutral-900/[0.05] dark:bg-white/[0.05] flex text-sm rounded-full font-medium text-neutral-900 dark:text-white ${
